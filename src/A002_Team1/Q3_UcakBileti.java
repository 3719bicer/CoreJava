...
public class Q3_UcakBileti {
   ...
   */
    public static void main(String[] args) {
        ...
        System.out.println("Java Airlines'a hosgeldiniz ! \nLutfen ucmak istediginiz sehri giriniz \n(B | C | D)");
        String city = scan.next().toLowerCase();

        System.out.println("Ucusunuzu tek yon olarak mi tercih edersiniz gidis-donus olarak cift yon mu? " +
        ...
        if (city.equals("b") || city.equals("c") || city.equals("d")) {
            ...
            if (age > 65) {
                if (city.equals("b")) {
                    if (flightType == 1) {
                        System.out.println("***************************************************");
                        System.out.println("Girdiginiz bilgilere gore biletinizin tutari : " + (priceB * 0.70) * 0.80 + "€"); // bu satirda indirimi uygulamak icin indirim tutarini(ornegin %20 indirimi *0.80 olarak yaptim) fiyatla carptim
                ...
                if (city.equals("c")) {
                    if (flightType == 1) {
                        System.out.println("***************************************************");
                        System.out.println("Girdiginiz bilgilere gore biletinizin tutari : " + (priceC * 0.70) * 0.80 + "€");// bu satirda indirimi uygulamak icin indirim tutarini(ornegin %20 indirimi *0.80 olarak yaptim) fiyatla carptim
                    } else if (flightType == 0) {
                        System.out.println("***************************************************");
                ...
                if (city.equals("d")) {
                    if (flightType == 1) {
                        System.out.println("***************************************************");
                        System.out.println("Girdiginiz bilgilere gore biletinizin tutari : " + (priceD * 0.70) * 0.80 + "€");
                    } else if (flightType == 0) {
                        System.out.println("***************************************************");
                ...
                if (city.equals("b")) {
                    if (flightType == 1) {
                        System.out.println("***************************************************");
                        System.out.println("Girdiginiz bilgilere gore biletinizin tutari : " + (priceB * 0.90) * 0.80 + "€");
                    } else if (flightType == 0) {
                        System.out.println("***************************************************");
