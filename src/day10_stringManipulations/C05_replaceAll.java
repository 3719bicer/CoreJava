...
public class C05_replaceAll {
    public static void main(String[] args) {
        ...
        /*
        String str1="J1a2va3 G4u5z6e7l8d9i0r";
        str1=str1.replaceAll("\\d","" );
        System.out.println(str1); //Java Guzeldir

        String str2="Java     Güzel bir programlama     dili";
        str2=str2.replaceAll("\\s+"," ");
        System.out.println(str2); //Java Guzel bir programlama dili
         */
