...
public class Q6_UcakBileti_aysehoca {
        ...
        if (city.equals("b") || city.equals("c") || city.equals("d")) {
            ...
            if (age > 65) {
                if (city.equals("b")) {
                    if (flightType == 1) {
                        System.out.println("***************************************************");
                        System.out.println("Girdiginiz bilgilere gore biletinizin tutari : " +
                                (priceB*0.70)*0.80+"€" );
                        // bu satirda indirimi uygulamak icin indirim tutarini
                        // (ornegin %20 indirimi *0.80 olarak yaptim) fiyatla carptim
