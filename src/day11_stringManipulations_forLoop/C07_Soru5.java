...
public class C07_Soru5 {
    public static void main(String[] args) {
        ...
        */
        ...
        if (!(sifre.charAt(0)>='a' && sifre.charAt(0)<='z')){
            System.out.println("Sıfre ilk harf kucuk harf olmali");
            kontrol=false;
        } else if (!(sifre.charAt(sifre.length()-1)>='0' && sifre.charAt(sifre.length()-1)>='9')) {
            System.out.println("Sıfre son karakter rakam olmali");
            kontrol=false;
        } else if (!(sifre.contains(" "))) {
            System.out.println("sifre bosluk icermemeli");
            kontrol=false;
        } else if (!(sifre.length()<10)) {
            System.out.println("Sıfre uzunlugu en az 10 karakter olmali");
            kontrol=false;
        }else if (kontrol){
